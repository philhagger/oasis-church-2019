...
import logoSmall from './logo-white-sm.png';
import logoMedium from './logo-white-md.png';
import './Footer.scss';
    ...
    <footer className='footer'>
      <div className='footer__logo-box'>
        <picture className='footer__logo'>
          <source src={logoSmall} media='(max-width: 37.5em)' />
          <img
            src={logoSmall}
            srcSet={`${logoSmall} 200w, ${logoMedium} 600w`}
            alt='Oasis Logo'
